...
# Ⅵ. 설계시 마주한 문제점.
## 1. 최소 이동 거리 문제
### 구한 원의 중심의 위치와 드론의 위치가 20cm일때 텔로 드론의 최소 이동거리가 20cm라 중심에서 더 벗어나는 상황이 발생하는 경우가 있었습니다. 따라서 중심과 드론사이의 거리가 12cm 미만일 경우는 이동을 하지 않았고 사이의 거리가 12~20cm는 20cm를 이동하도록 하였습니다.
<pre>
<code>
